...
export class OrdersToolbarComponent {
    // Aquí puedes definir las propiedades y métodos necesarios para la barra de herramientas
    // Por ejemplo, para manejar la creación de órdenes, filtros, etc.
    ...
    selectedSupplyFilter: number | null = null;
